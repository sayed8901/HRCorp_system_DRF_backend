...
class SalaryInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['employee_id', 'is_confirmed', 'salary_grade', 'salary_step', 'starting_basic', 'salary_step', 'effective_basic', 'other_allowance', 'festival_bonus', 'house_rent', 'medical_allowance', 'conveyance', 'hardship', 'pf_contribution', 'gross_salary', 'pf_deduction', 'swf_deduction', 'salary_deduction_npl', 'tax_deduction', 'net_salary', 'consolidated_salary']
